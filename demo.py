...
def find_best_frame(source, driving, cpu):
    ...
    # Cihaz ayarı CPU olarak sabitlendi
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cpu", dest="cpu", action="store_true", default=True, help="CPU mode (Enabled by default)")
    ...
    # Cihazı her zaman CPU seçmeye zorluyoruz
    ...
    if opt.find_best_frame:
        i = find_best_frame(source_image, driving_video, True)
